...
\name{Samuel}{Dubuis}
\position{Student{\enskip\cdotp\enskip}Teaching-assistant}
...
\lettertitle{Job application for college student}
...
\begin{cvletter}
	...
	%The company's reputation really attracts me, it would be a great opportunity.
